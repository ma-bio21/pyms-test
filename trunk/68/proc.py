...
andi_data = "/x/proj.archive/proj/PyMS/data/pyms-data//121107B_10.CDF"
xcalibur_peaks = "/x/proj.archive/proj/PyMS/data/pyms-data/121107B_10_xcalibur_peaks.txt"
amdis_peaks = "/x/proj.archive/proj/PyMS/data/pyms-data//121107B_10.ELU"

amdis_expr = load_amdis_expr(amdis_peaks)
xcalibur_expr = load_xcalibur_expr(xcalibur_peaks,andi_data)
